...
int main(int, char**)
{
    ...
    ioA.Fonts->AddFontFromFileTTF("C:/Windows/Fonts/Arial.ttf", 18);
  //  ioA.Fonts->AddFontFromFileTTF("C:/Users/bentl/source/repos/JugendForschtBahn/FontAwesome.ttf", 18);
    //ioA.Fonts->AddFontDefault();
    static const ImWchar icons_ranges[] = { ICON_MIN_FA, ICON_MAX_FA, 0 };
    ImFontConfig icons_config; icons_config.MergeMode = true; icons_config.PixelSnapH = true;
    io.Fonts->AddFontFromFileTTF("C:/Users/bentl/source/repos/JugendForschtBahn/FontAwesome.ttf", 16.0f, &icons_config, icons_ranges);
    ...
    while (!done)
    {
       ...
       Window::RenderWindow();
        Window::RenderConnectionWindow();
        Window::RenderFinalWindow();
        Window::Theme();
